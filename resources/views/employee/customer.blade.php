...
<body>
    <div class="d-flex" id="wrapper">
        ...
        @include('employee.layout.header')
                ...
                <div class="container">
                    @if(isset($personalBooking) && count($personalBooking) > 0)
                    <h2 style="text-align: center">Personal Booking</h2>
                    ...
                    <table class="table" style="margin-bottom: 150px">
                        ...
                        <tbody>
                            @foreach ($personalBooking as $booking)
                                <tr>
            ...
            <div  class="modal fade" id="bookingModal{{ $booking->BookingID }}" tabindex="-1" aria-labelledby="bookingModalLabel" aria-hidden="true""
                ...
                @else
                    <h1 style="text-align: center">Personal Booking</h1>
                    <h3 style="text-align: center; margin-bottom: 150px">No bookings Found</h3>
                @endif
                    ...
                    <h1 style="text-align: center">Choose your random Bookings</h1>
                    <!-- Your table or other HTML content -->
                    <table class="table">
                        <thead>
                            <tr>
