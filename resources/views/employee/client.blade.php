                                        ...
                                        <div class="align-items-center row">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="candidate-list-content mt-3 mt-lg-0">
                                                    <h5 class="fs-19 mb-0">
                                                        <a class="primary-link" href="#">{{ $booking->users->name }}</a><span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i>4.8</span>
                                                    </h5>
                                                    <p class="text-muted mb-2">{{ $booking->users->email  }}</p>
                                                    <ul class="list-inline mb-0 text-muted">
                                                        <li class="list-inline-item"><i class="mdi mdi-wallet"></i> ₱ {{ $booking->amount  }} hours</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="mt-2 mt-lg-0 d-flex flex-wrap align-items-start gap-1">
                                                    ...
                                                    <div class="profile">
                                                        ...
                                                        @if($booking->payment_status == 'paid')
                                                            <form method="post" action="{{ route('complete.booking', ['bookingId' => $booking->BookingID]) }}" style="display: inline;">
                                                                @csrf
                                                                <button type="submit" class="btn btn-success btn-sm">Done</button>
                                                            </form>
                                                        @endif
                                                        <form method="post" action="{{ route('cancel.booking', ['bookingId' => $booking->BookingID]) }}" style="display: inline;">
                                                            @csrf
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-6 mb-3">
                                                <h6>Name</h6>
                                               <p class="text-muted">{{ $booking->users->name}} </p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>Email</h6>
