        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-danger mb-lg-4">TemPaw Care</h1>
                    <h1 class="text-uppercase text-light mb-lg-4">Make Your Pets Happy</h1>
                    <p class="fs-4 text-light mb-lg-4">Our mission is to ensure the well-being and safety of pets when their owners are unable to look after them temporarily.</p>
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                        <a href="/about" class="btn btn-outline-danger border-2 py-md-3 px-md-5 me-5">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="text-body mb-4">TemPaw Care is a dedicated organization that specializes in providing temporary care for animals. Our mission is to ensure the well-being and safety of pets when their owners are unable to look after them temporarily. With a team of passionate animal lovers and a network of trusted caregivers, we offer a range of services to ensure that animals receive the attention, love, and care they need during their owners' absence. </p>
